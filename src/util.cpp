...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Hera
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Hera
    // Mac: ~/Library/Application Support/Hera
    // Unix: ~/.Hera
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hera";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Hera.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Herad.pid"));
