...
private slots:
    ...
    QString BuyHER(QString OrderType, double Quantity, double Rate);
    QString SellHER(QString OrderType, double Quantity, double Rate);
