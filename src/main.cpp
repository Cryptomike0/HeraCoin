...
const string strMessageMagic = "Hera Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
	...
	if (nHeight < 550001) {
		...
		nSubsidy = STATIC_POS_REWARD * 0.75;
	}
	else {
		nSubsidy = STATIC_POS_REWARD * 0.375;
	}
    return nSubsidy + nFees;
}
